...
export default {
    ...
    configure: async (cobalt, context) => {
        cobalt.config.set('project', {
            artifact: { artifact: 'Phx.Test', version: '0.3.1' },
            description: 'Test verification and execution utilities.',
            packageProjectUrl: 'https://github.com/StarCruiseStudios/PhxTest',
            tags: 'phxlib,starcruisestudios',
            repositoryUrl: 'https://github.com/StarCruiseStudios/PhxTest',
        ...
        cobalt.dependencies.add(
            context.versions.phx.lib,
            context.versions.phx.validation,
            context.versions.nlog.nlog,
            context.versions.nunit.nunit,
        )
    }
}
