...
namespace Phx.Test {
    ...
    /// <summary>
    ///     An exception that is only thrown by a test. Can be used to differentiate from other
    ///     exceptions that may occur when checking for an exception.
    /// </summary>
    [Serializable]
    public class TestException : Exception {
        ...
        /// <param name="message"> The message that describes the error. </param>
        /// <param name="inner">
        ///     The exception that is the cause of the current exception, or <c> null </c> if
