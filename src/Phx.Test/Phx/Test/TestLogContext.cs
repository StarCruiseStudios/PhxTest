...
{
    /// <summary>
    ///     Provides helper methods for readability and auditing of test values.
    /// </summary>
    public sealed class TestLogContext
    {
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="TestLogContext"/> class.
        /// </summary>
        ...
        /// <summary>
        ///     Defines a value that is part of the initial test context that will be operated on.
        /// </summary>
        /// <remarks>
        ///     A function is provided instead of the direct value, so that any errors that occur while computing the
        ///     value are handled and displayed correctly.
        /// </remarks>
        ...
        /// <param name="value"> Computes the given value that is returned so it can be assigned to a test variable.
        ///                      </param>
        ...
        /// <summary>
        ///     Defines a state or condition that is part of the initial test context that will be operated on.
        /// </summary>
        /// <param name="description"> Provides more details about the purpose of the value. </param>
        ...
        /// <summary>
        ///     Defines an action that is being tested.
        /// </summary>
        ...
        /// <summary>
        ///     Defines an expected outcome of a test. This should be an assertion on a value that is returned from an
        ///     action under test.
        /// </summary>
        ...
        /// <param name="description"> Provides more details about the assertion. </param>
        /// <param name="expectedValue"> The expected value that is validated by the assertion. This value is only
        ///                              provided for logging. No addition validation is performed beyond the provided
        ///                              assertion function. </param>
        /// <param name="assertion"> The assertion to be performed. </param>
        /// <returns> The result of performing the assertion. </returns>
        ...
        /// <summary>
        ///     Logs a message that will appear inline with the other test steps in the log output.
        /// </summary>
        ...
        /// </summary>
        /// <remarks>
        ///     This method should be invoked from the test start lifecycle method.
        /// </remarks>
        ...
        /// <summary>
        ///     Ends the logging context and displays the executed steps.
        /// </summary>
        /// <remarks>
        ///     This method should be invoked from the test cleanup lifecycle method.
        /// </remarks>
        /// <param name="success"> A value indicating whether the test completed successfully. </param>
        public void LogEnd(bool success)
        {
            LogSteps();
            var result = success ? TestResults.PASSED : TestResults.FAILED;
