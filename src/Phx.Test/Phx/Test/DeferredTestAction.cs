...
namespace Phx.Test {
    ...
    /// <summary>
    ///     Wraps a test action that was deferred by a DeferredWhen step.
    ///
    ///     The test class will track this action and fail if it is not executed before the test is complete.
    /// </summary>
    public sealed class DeferredTestAction {
        /// <summary>
        ///     Gets a description of the deferred action.
        /// </summary>
        public string Description { get; }
        
        /// <summary>
        ///     Gets a value indicating whether the deferred action has been executed.
        /// </summary>
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="DeferredTestAction"/> class.
        /// </summary>
