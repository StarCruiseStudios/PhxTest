...
{
    /// <summary>
    ///     The exception that is thrown when a verification condition is false.
    /// </summary>
    [Serializable]
    public sealed class VerificationFailedException : Exception
    {
        ...
        /// </summary>
        /// <param name="message">The message that describes the error.</param>
        /// <param name="innerException"> The exception that is the cause of the current exception, or <c>null</c> if no
