...
{
    /// <summary>
    ///     Test base class that manages a <see cref="TestLogContext"/> and exposes convenience methods for invoking it.
    /// </summary>
    public abstract class LoggingTestClass
    {
        ...
        /// <summary>
        ///     Initializes the log context on test start.
        /// </summary>
        [SetUp]
        ...
        /// <summary>
        ///     Ends the log context on test cleanup.
        /// </summary>
        [TearDown]
